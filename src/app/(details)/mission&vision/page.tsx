        ...
        <section className="max-w-5xl mx-auto">
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg mb-10 transform transition hover:scale-105">
            ...
            <p className="text-lg text-gray-700 text-justify mb-6 leading-relaxed">
              At Opal Hotels, our mission is to provide an exceptional and memorable hospitality experience to every guest we serve. We are dedicated to delivering outstanding service, luxurious accommodations, and a warm, welcoming atmosphere. Our goal is to exceed our guests' expectations through personalized service, attention to detail, and a commitment to excellence.
            </p>
