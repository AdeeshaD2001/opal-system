...
const HotelCard: React.FC<Hotel> = ({
  ...
  <div className="bg-white rounded-lg shadow-md p-4 mb-6 border border-[#836666] w-full max-w-4xl mx-auto">
    <div className="flex">
      <img src={image} alt={name} className="w-2/5 rounded-l-lg object-cover" />
...
export default function LatestHotels() {
  const [visibleHotels, setVisibleHotels] = React.useState(3);
